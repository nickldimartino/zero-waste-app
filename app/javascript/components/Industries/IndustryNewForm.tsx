...
export default function IndustryForm({ handleChange, handleSubmit }: {handleChange: any, handleSubmit: any}) {
  return (
    <form onSubmit={handleSubmit} className="d-flex flex-column align-items-center border border-2 border-warning rounded m-2 p-2 w-25 shadow">
